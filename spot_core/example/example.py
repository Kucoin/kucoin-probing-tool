...
create_sub_account_res = client.create_sub_account(password=password, sub_name=sub_name, access='Spot')
print(create_sub_account_res)

create_apis_for_sub_account_res = client.create_apis_for_sub_account(sub_name=sub_name,
                                                                     passphrase=password, remark='apiRemark')
print(create_apis_for_sub_account_res)
sub_account_api_list = client.get_sub_account_api_list(sub_name=sub_name)
print(sub_account_api_list)

modify_apis_for_sub_account_res = client.modify_sub_account_apis(sub_name=sub_name, passphrase=password,
                                                                 api_key='')
print(modify_apis_for_sub_account_res)
sub_account_api_list = client.get_sub_account_api_list(sub_name=sub_name)
print(sub_account_api_list)

delete_apis_for_sub_account_res = client.delete_sub_account_apis(sub_name=sub_name, passphrase=password,
                                                                 api_key='')
